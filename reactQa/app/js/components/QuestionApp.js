...
module.exports = React.createClass({
		...
		var questions = [
			{
				...
				description:'理性探讨，请勿口出狂言。产品经理的主要工作是负责产品设计。接受来自其他部门的需求，经过设计后交付研发。但这里有好些职责不清楚的地方。',
				voteCount: 22,
			},
			{
				key:2,
				title: '热爱编程是一种怎样的体验？',
				description:'别人对玩游戏感兴趣，我对写代码、看技术文章感兴趣；把泡GitHub、stackoverflow、 v2ex、reddit、csdn当做是兴趣爱好；遇到重复的工作，总想着能不能通过程序实现自动化；喝酒的时候把写代码当下酒菜，边喝边想边敲；不给工资我也回来加班，做梦都在写代码。',
				voteCount: 10,	
			}
		];
		return{
	...
	onVoteCount:function(key,newCount){
		...
		return (
			<div>
				...
				<div className="main container">
					...
					<QuestionList onVoteCount={this.onVoteCount} questions={this.state.questions} />
				</div>
			</div>
		)
	}
